...
class TestPaymentExample:
    ...
    def test_payment_request_channel_pattern(self):
        ...
        channel = channel_func(direction="request", session_id="session789")
        
        assert channel == "PaymentRequestMessage:request:session789"
    
    def test_payment_agent_handles_request(self):
    ...
    def test_payment_agent_validates_messages(self):
