...
class TestBaseMessage:
    ...
    def test_message_must_implement_get_channel_pattern(self):
        ...
        with pytest.raises(TypeError) as exc_info:
            ...
            message = InvalidMessage(data="test")
        
        assert "get_channel_pattern" in str(exc_info.value)
    
    def test_message_with_channel_pattern_instantiates(self):
    ...
    def test_message_inherits_pydantic_validation(self):
        ...
        with pytest.raises(ValidationError):
            TypedMessage(count="not_a_number", name="test")


class TestBaseAgent:
    """Test the BaseAgent contract."""
    
    def test_agent_must_implement_handle_message(self):
    ...
    def test_agent_message_declarations(self):
    ...
    def test_agent_validate_incoming_message(self):
    ...
    def test_agent_validate_outgoing_message(self):
    ...
    def test_agent_handle_message_receives_context(self):
