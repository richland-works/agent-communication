...
class TestJSONLineFormatter:
    ...
    def test_format_creates_valid_json_line(self) -> None:
    ...
    def test_timestamp_format_iso_with_z(self) -> None:
    ...
    def test_get_logger_returns_configured_logger(self) -> None:
        ...
        logger.info(
            "Test message", extra={"agent_id": "test_1", "session_id": "xyz789"}
        )
    ...
    def test_multiple_log_lines_are_separate_json_objects(self) -> None:
